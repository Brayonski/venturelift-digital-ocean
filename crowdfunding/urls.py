...
urlpatterns = [
    ...
    url(r'^register_url$', views.register_url, name='register_url'),
    url(r'^confirmation_url$', views.confirmation_url, name='confirmation_url'),
    url(r'^validation_url$', views.validation_url, name='validation_url'),
